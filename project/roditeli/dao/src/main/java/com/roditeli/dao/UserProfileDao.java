...
public class UserProfileDao extends BaseDao<UserProfile>implements IUserProfileDao{
	...
	@Override
	public UserProfile getUserProfileByUser(int userId) throws HibernateException{
		UserProfile userProfile = null;
		userProfile = (UserProfile)getCriteria().createCriteria("user", JoinType.RIGHT_OUTER_JOIN)
